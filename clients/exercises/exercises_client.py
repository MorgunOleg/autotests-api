...
class GetExerciseResponseDict(TypedDict):
    """
    Описание структуры ответа на получение, создание и обновление задания.
    """
    exercise: Exercise
...
class ExercisesClient(APIClient):
    ...
    def get_exercises_api(self, query: GetExercisesQueryDict) -> Response:
        """
        Метод получения списка заданий определенного курса.
    ...
    def create_exercise_api(self, request: CreateExerciseRequestDict) -> Response:
        ...
        :param request: Словарь с параметрами задания: title, courseId, maxScore, minScore,
    ...
    def update_exercise_api(self, exercise_id: str, request: UpdateExerciseRequestDict) -> Response:
        ...
        :param exercise_id: Идентификатор задания.
        :param request: Словарь с данными задания: title, maxScore, minScore, orderIndex,
